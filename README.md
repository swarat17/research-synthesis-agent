...
```mermaid
graph LR
    A([User Query]) --> B[Router<br/>GPT-4o-mini]
    B --> C[ArXiv Fetcher]
    C --> D[Deduplicator]
    D --> E[Synthesizer<br/>Claude Sonnet 4.6]
    E --> F[Contradiction Detector<br/>GPT-4o-mini]
    F --> G[Hypothesis Generator<br/>Claude Sonnet 4.6]
    G --> H[Cost Auditor<br/>Supabase]
    H --> I([Response])
```
